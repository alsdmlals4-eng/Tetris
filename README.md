...
- CORE-029 Production runtime: **main에 구현됨**; `AUTOMATED_VERTICAL_SLICE_READY` 근거는 runtime baseline main `1a5c5aa`와 tree-equivalent인 source head의 CI/runtime 증거이며, 별도 main-commit runtime 영수증은 아직 없습니다.
