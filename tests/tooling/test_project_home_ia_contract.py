...
class ProjectHomeIaContractTests(unittest.TestCase):
    def test_tetris_home_and_ai_workspace_roles_are_machine_readable(self) -> None:
        ...
        self.assertEqual(data["skill_authority"], "TETRIS-SKILL-039")
        self.assertEqual(data["skill_content_authority"], "TETRIS-SKILL-042")
        self.assertEqual(data["balance_authority"], "TETRIS-BALANCE-040")
