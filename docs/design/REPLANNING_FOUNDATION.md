...
- **2026-09-21 puzzle/skill presentation:** approved combo/fanfare and named skill result now use the existing `resource_choice.tscn` entry. [Current plan](R3_FALLING_CHAIN_AND_DISRUPTION_SPEC.md) and [evidence/readback](../validation/puzzle-feedback-20260921/README.md) own this bounded presentation-only slice. Existing economy, shared clock, saves, default scene, actors and asset provenance remain unchanged. Local571/7758 Godot tests and95tooling tests pass; native1280/960 captures and independent review completed, including reserved SWAP symbol-color correction. GitHub/main and cumulative journal publication are tracked in that evidence record; do not infer their completion from code alone. Next product scope remains HUMAN rhythm/audio-fatigue/beginner observation and separately approved campaign/menu adoption, not whole-game/final-art/release completion.
