...
| 5 · Validation/merge evidence | Run full Godot/GUT and tooling suites; compare exact branch/remote after permitted commit and push. | Pending final exact-head readback at the end of this task; no `main` merge is implied. |
